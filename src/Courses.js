...
import { Row, Col, Container, Button, Card, Table, Pagination } from 'react-bootstrap';
...
function Courses() {
  return (
    ...
    <Button style={{marginLeft:"85%", marginTop:"-7%"}}>+ Add Course</Button>
...
Courses
    ...
    <Col></Col>
    <Col> </Col>
    <Col style={{marginLeft:"150px"}}> <Button style={{marginLeft:"15%", marginTop:"-7%"}}>Export</Button>
    <Button style={{marginLeft:"10%", marginTop:"-7.5%"}}>Filter</Button>
    </Col>
